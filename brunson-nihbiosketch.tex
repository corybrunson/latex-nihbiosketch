...
%PROJECT
I will work with the project team in any capacity I am able, but specifically:
...
I will work wit Dr. Prosperi to design, implement, and document the transfer learning procedure of Aim 2.2.
In each case, I will also contribute to the open-access publication of these models on established code repositories.
Finally, I will work with the Model and Data Sharing Core to convert and validate models in multiple software languages and on diverse platforms, and to publish them with clear documentation including fully worked through examples online.
