...
%2019       & \pkg{rmfr}: Calculate Minimal Functional Routes through Expanded Graphs (with Sordo Vieira) \\
%2019       & \pkg{pmodpy}: Graph Modulus in Python (with Sordo Vieira) \\
%2019       & \pkg{reebr}: Construction and Visualization of Statistical Reeb Graphs \\
\end{datelngtbl}
